  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Ozove offers a seamless ride booking experience across Australia. Manage your fleet, book individual or business rides, and enjoy hassle-free transportation."
        />
        <meta
          name="keywords"
          content="Ozove, ride booking, fleet management, driver management, business rides, individual rides, Australia"
        />
        ...
        <meta
          property="og:title"
          content="Ozove - Simplified Ride Booking and Fleet Management in Australia"
        />
        <meta
          property="og:description"
          content="Book rides and manage your fleet effortlessly with Ozove, tailored for both individual and business needs across Australia."
        />
